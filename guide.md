...
1. Learn to describe motion.
2. Learn what causes changes in motion.
3. Learn conservation laws that make difficult force problems easier.
4. Learn how constraints and machines redistribute force, distance, speed, and torque.
5. Learn rotational mechanics, which unlocks richer applications such as bowling, bicycle gearing, rolling motion, levers, and gyroscopes.
6. Finish with visually surprising problems and nonlinear systems.
...
> Keep projectile simulations theoretical and educational. Do not include
> real-world weapon construction, targeting, or performance-optimization
> guidance.
...
> Action-reaction forces do not cancel each other because they act on
> different objects.
...
Why it is valuable: the ballistic pendulum combines two different solution
methods:

1. Momentum conservation during the collision.
2. Energy conservation after the collision.
...
This section introduces mechanical advantage and the principle that ideal
...
> Input work = output work, for an ideal machine.
...
> Centrifugal force is an apparent force used in a rotating frame. In an
> inertial frame, the required force is directed toward the center.
...
**The surprise:** A double cone placed on diverging rails appears to roll
uphill.

**Resolution:** Its center of mass actually moves downward as the rails
spread apart.
...
Suggested simulation — allow users to adjust:
...
**The surprise:** Pulling a string wound around a spool can make the spool
roll either toward the pulling force or away from it.
...
Suggested experiment: use a spool, thread, and a gentle pulling force.
Compare shallow and steep pulling angles.

### Rolling race

**The surprise:** A hoop, disk, cylinder, and sphere released from the same
height do not reach the bottom at the same time.
...
Suggested experiment: roll different shaped objects down the same ramp and
record the motion in slow-motion video.

### Falling slinky

**The surprise:** The bottom of a stretched slinky can remain almost
motionless immediately after release.
...
Suggested experiment: record a falling slinky in slow motion and identify
when the lower end begins to move.

### Atwood's machine

**The surprise:** A simple two-mass pulley system becomes more subtle when
pulley inertia, rope mass, or friction are included.
...
Suggested simulation — include toggles for:
...
**The surprise:** A load lifted by a movable pulley rises only part of the
distance that the free end of the rope is pulled.
...
Suggested simulation — animate every rope segment and display:
...
**The surprise:** A chain falling from a container can rise above the rim
before descending.
...
Suggested project approach — present multiple levels:
...
**The question:** What curve lets a bead travel between two points in the
least time under gravity?

**The surprise:** The straight-line path is not the fastest path.

**Result:** The ideal curve is a cycloid.
...
Suggested simulation — compare travel times along:
...
**The surprise:** A bead sliding on an inverted cycloid reaches the bottom in
the same time from different starting positions.
...
Suggested simulation: release several beads from different points
simultaneously and compare arrival times.

### Catenary versus parabola

**The surprise:** A freely hanging uniform chain forms a catenary, not a
parabola.
...
Suggested experiment: hang a chain, photograph it, and compare a fitted
catenary with a fitted parabola.

### Tennis-racket theorem

**The surprise:** Rotation about an object's intermediate principal axis is
unstable, causing unexpected flipping.
...
Suggested simulation: create a 3D rectangular-body simulation where users can
choose the initial axis of rotation and observe stable versus unstable
motion.

### Gyroscopic precession

**The surprise:** A torque applied to a spinning wheel produces motion in a
direction that may not match naive intuition.
...
Suggested experiment: use a bicycle wheel suspended by one axle and observe
its precession.

### Bead on a rotating hoop

**The surprise:** As hoop rotation increases, the stable equilibrium position
of a bead can split into new equilibrium positions.
...
Suggested simulation: plot the effective potential as a function of rotation
rate and show equilibrium locations.

## 10. Real-World Capstone Simulations

These are larger multi-topic projects. They should be built incrementally
...
4. Friction between ball and lane
5. Simplified hook-path model
6. Ball-pin collisions
7. Multi-pin scatter simulation
...
1. Gear ratio
2. Cadence and wheel speed
3. Torque at the rear wheel
4. Hill climbing
5. Power
6. Braking
7. Traction and cornering
8. Rolling resistance and aerodynamic drag
...
2. Ramps and hills
3. Loops
4. Normal force and apparent weight
5. Frictional loss
6. Track curvature
...
5. Resonance
6. Coupled modes
7. Structural-design discussion
...
This should remain an educational model of elastic-energy transfer, not an
instructional construction guide.

Build in stages:

1. Spring-like force model
2. Elastic potential energy
3. Draw length
4. Projectile mass
5. Launch speed
6. Energy-transfer efficiency
7. Simplified projectile trajectory
...
This should focus on abstract mechanics and numerical modeling rather than
constructing or optimizing physical devices.

Build in stages:

1. Simple projectile motion
2. Specified launch speed and angle
3. Lever-arm geometry
4. Torque
5. Rotational inertia
6. Energy transfer
7. Release timing as an abstract parameter
...
1. Motion graphs and constant acceleration
2. Projectile-motion explorer
3. Free-body diagrams and inclined planes
4. Friction and braking distance
5. Energy and roller-coaster ramps
6. Momentum and collisions
7. Levers and torque balance
8. Pulleys and mechanical advantage
9. Rolling race: hoop versus disk versus sphere
10. Double cone rolling uphill
...
> "What does the mathematics predict, what does intuition predict, and why
